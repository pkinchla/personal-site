/**
 * Vendored from https://www.speedlify.dev/js/speedlify2-score.js on 2026-08-25.
 * The upstream docs (https://www.speedlify.dev/embed/) explicitly ask that this
 * NOT be hotlinked — "no versioning, no deprecation policy and no uptime
 * commitment" — so it's checked into the repo instead. Re-run
 * `pnpm fetch:speedlify2-score` to pull a fresh copy when needed.
 */
