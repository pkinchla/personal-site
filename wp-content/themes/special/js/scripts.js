...
var HandleLinks = function () {
  function HandleLinks() {
    _classCallCheck(this, HandleLinks);
  ...
  _createClass(HandleLinks, [{
    key: 'internalLink',
    value: function internalLink(e) {
      e.preventDefault();
      (0, _helpers.addClass)(this.options.htmlEl, 'exit');
      setTimeout(function () {
    ...
    key: 'paginationLink',
    value: function paginationLink(e) {
      if (!self.fetch) return;
      e.preventDefault();
      e.stopPropagation();

      var target = document.querySelector('.js-pagination-target'),
          element = document.querySelector('.js-pagination-element'),
          pagination = document.querySelector('.js-pagination-block');

      (0, _helpers.addClass)(element, 'removing');
      (0, _helpers.addClass)(pagination, 'removing-pagination');
      (0, _helpers.addClass)(target, 'loading');

      (0, _helpers.removeClass)(element, 'adding');
      (0, _helpers.removeClass)(pagination, 'adding-pagination');

      fetch(e.target.href).then(function (response) {
        ...
        (0, _helpers.addClass)(elementData, 'adding');
        (0, _helpers.addClass)(paginationData, 'adding-pagination');
        (0, _helpers.removeClass)(target, 'loading');
    ...
    value: function handleClick(e) {
      ...
      if (e.target.href.includes('#')) {
        return;
      } else if ((0, _helpers.hasClass)(e.target, 'js-pagination')) {
  ...
  _createClass(MobileMenu, [{
    ...
    value: function setupComponent() {
      ...
      var items = function items() {
        var items = [];
        for (var index = 0; index < _this.options.selector.firstElementChild.children.length; index++) {
          var element = _this.options.selector.firstElementChild.children[index];
          var item = {
        ...
        _createClass(Menu, [{
          ...
          value: function render() {
            ...
            return (0, _preact.h)(
              ...
              (0, _preact.h)(
                'button',
                { className: 'main-nav-toggle ' + (!this.state.menuOpen ? '' : ' close-state'), onClick: function onClick() {
                    return _this3.toggleMenu();
                  } },
                (0, _preact.h)(
                  'svg',
                  { 'class': 'main-nav-button', viewBox: '0 0 225 164.7', width: '22.5', height: '16.47' },
                  (0, _preact.h)('rect', { 'class': 'one', y: '0', width: '225', height: '23.7' }),
                  (0, _preact.h)('rect', { 'class': 'two', y: '70.5', width: '225', height: '23.7' }),
                  (0, _preact.h)('rect', { 'class': 'three', y: '141', width: '225', height: '23.7' })
                ),
                (0, _preact.h)(
                  'span',
                  { className: 'label' },
              ...
              (0, _preact.h)(
                'ul',
                { id: 'primary-menu', className: 'menu ' + (this.state.menuOpen ? 'open' : 'closed') },
      ...
      (0, _preact.render)((0, _preact.h)(Menu, null), this.options.target);
    }
  }, {
    key: 'init',
    value: function init() {
...
var _HandleLinks = require('./HandleLinks');

var _HandleLinks2 = _interopRequireDefault(_HandleLinks);
...
(function (document) {
	...
	var handleLinks = new _HandleLinks2.default();
	handleLinks.init();
