	...
	<footer id="colophon" class="site-footer" role="contentinfo">
      ...
      <small>All associated logos are trademarks or registered trademarks or service marks of their respective owners. All rights reserved. Any use of these is done for non-commercial purposes unless otherwise noted.</small>
		...
		<div class="footer-col1">	
			<h5>Colophon</h5>
			<small>This site is set in Skolar Web and Futura PT. Typefaces are being served up via <a href="https://typekit.com/">Typekit</a>. Handcrafted with <a href="http://validator.w3.org/check?uri=referer">HTML</a>, CSS and built on <a href="https://wordpress.org/">Wordpress</a></small>
